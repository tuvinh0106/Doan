...
<li class="breadcrumb-item active" aria-current="page" ><a href="html5-editor.php" class="bg-light-blue btn text-blue ">Thêm mới</a></li>
								</ol>
							</nav>
						</div>
							...
							<div class="profile-tab height-100-p">
								<div class="tab height-100-p">
									<ul class="nav nav-tabs customtab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Thời Gian Hoạt Động</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#setting" role="tab">Thông Tin</a>
										</li>
									</ul>
