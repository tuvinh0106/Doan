				...
				<div class="col-md-6 col-lg-5">
					<div class="register-box bg-white box-shadow border-radius-10">
						<div class="wizard-content">
							<form action="../controller/xulydangky.php" method="POST" id="frmDangKy" class="tab-wizard2 wizard-circle wizard">
								...
								<div class="custom-control custom-checkbox mt-4">
									<button type="submit" value="submit" id="success-modal-btn" hidden data-toggle="modal" data-target="#success-modal" data-backdrop="static"></button>
								</div>
							</form>
						</div>
					</div>
