            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="chitietsanpham.php">Chi tiết sản phẩm</a>
                                </li>
                        ...
                        if (isset($_SESSION["email"])) {
                            echo '  <li class="nav-item submenu dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> ' . $_SESSION["email"] . '</a>
                                    <ul class="dropdown-menu">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-item"><a href="giohang.php" class="cart"><span class="ti-bag"></span></a></li>
                        <li class="nav-item">
